...
//             onClick={() => dispatch({ type:"token", payload: null })}
//           >
//             logout
//           </div>
    ...
    return (
        <div className='navbar_container'>
            ...
            <div className='navbar_items'>
                ...
                <span><a className='navbar_item'>Video Song</a></span>
                <span><a className='navbar_item'>Documentary</a></span>
                <span><a className='navbar_item'>TV Show</a></span>
                <span><a className='navbar_item'>Short Film</a></span>
                <span><a className='navbar_item'>Trailer</a></span>
                <span><a className='navbar_item'>Web Series</a></span>
                <Link to='/additem'>
                <span><a className='navbar_item'>myList</a></span>
                </Link>
