    ...
    <div className="show_container">
      ...
      <div className="show_body_text">
        ...
        <div className="show_body_text_p1">
          ...
          <span className="dot"></span>
          <p>
            {selectedShow?.keywords[0]}, {selectedShow?.keywords[1]},{" "}
            {selectedShow?.keywords[2]}
          </p>
        </div>
        ...
        <div className="show_body_text_p2">
          ...
          <span className="show_body_text_p2_2">
            {selectedShow?.cast[0]}, {selectedShow?.cast[1]},{" "}
            {selectedShow?.cast[2]}
          </span>
        </div>
      </div>
      <div className="show_body_button">
        <Link to={`/video/${id}`}>
          <button className="show_body_watch">
            <span className="show_body_watch_image">
              <img src="https://images.slivcdn.com/UI_icons/New_Final_Icons_30052020/web_play_icon.png?h=24&w=24&q=high&fr=webp" />
            </span>
        ...
        <button className="show_body_subscribe">
          <div className="show_body_subscribe_div1">
            <span>
              <LiaCrownSolid style={{ width: "30px", height: "30px" }} />
            </span>
        ...
        <button className="show_body_list">
          <span>
            <FiCheck
              style={{ width: "23px", height: "23px", fontWeight: "700" }}
            />
          </span>
          <span>My List</span>
        </button>
      ...
      <div className="show_carousel">
        {selectedShow?.type === "movie" && movie?.length > 0 && (
          <>
            <h1>
              More Like This{" "}
              <span className="arrow_react_icon">
                <IoIosArrowForward />
              </span>
            </h1>
            <Carousel
